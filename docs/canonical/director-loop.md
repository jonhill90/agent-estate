...
2. Read docs/canonical/director-brief.md §3 and docs/canonical/phase-plan.md.
...
with real loop and graph engineering is Phase 6 of `docs/canonical/phase-plan.md`, and
